...
package com.example.herve.localmedia.utils.handler;
...
public class BJXExecutor {
    private static final BJXExecutor INSTANCE = new BJXExecutor();
    ...
    public static BJXExecutor getInstance() {
        return INSTANCE;
    }
