...
import com.example.herve.localmedia.utils.pickmedia.BasePickMedia;
...
import com.example.herve.localmedia.utils.pickmedia.pick_video.model.VideoBean;
                ...
                if (file.getName().endsWith(".mp4") && file.exists() && file.canRead() && file.canWrite()) {
                    ...
                    try {
                        ...
                        if (!mGroupMap.containsKey(parentName)) {
                            ...
                            ArrayList<VideoBean> newchileList = new ArrayList<>();
                            newchileList.add(VideoBean);
                            mGroupMap.put(parentName, newchileList);
                        } else {

                            ArrayList<VideoBean> chileList = mGroupMap.get(parentName);
