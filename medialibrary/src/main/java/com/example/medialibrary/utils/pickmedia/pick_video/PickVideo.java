package com.example.mylibrary.utils.pickmedia.pick_video;
...
import com.example.herve.localmedia.utils.pickmedia.pick_audio.SortDataList;
...
public class PickVideo implements PickMeaid<MediaBean> {
     ...
     * @return
     */
    private List<PickMediaTotal> subGroupOfPhoto(HashMap<String, List<MediaBean>> groupMap) {
